...
std::ostream& operator<<(std::ostream& strm, const Tree& tree) {
	return strm << tree.element;
}
...
Tree * erase(int value, Tree * t) 
{
	...
	else if (t->left && t->right)
	{
		...
		t->right = erase(t->element, t->right);
	}
	else
	{ 
		tmp_cell = t;
...
int main() 
{
	...
	//insert some stuff into it, and then erase it
	Tree* root;
	int i;
	root = NULL;    
